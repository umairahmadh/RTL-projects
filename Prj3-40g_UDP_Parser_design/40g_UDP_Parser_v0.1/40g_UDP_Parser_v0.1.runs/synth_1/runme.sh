...
HD_PWD='D:/Dev/ACCELR/Prj3-40g_UDP_Parser_design/40g_UDP_Parser_v0.1/40g_UDP_Parser_v0.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udp_parser_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udp_parser_top.tcl
