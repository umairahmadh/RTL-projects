...
HD_PWD='D:/Dev/ACCELR/Prj3-40g_UDP_Parser_design/udp1/udp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udp.tcl
